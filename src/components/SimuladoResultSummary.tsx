...
export const SimuladoResultSummary: React.FC<SimuladoResultSummaryProps> = ({
  ...
  return (
    <div className="bg-white border border-slate-200/60 rounded-2xl p-5 md:p-6 shadow-sm space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 bg-slate-50/60 p-4 rounded-xl border border-slate-100">
          <div className="relative w-36 h-36 shrink-0 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-2">
              ...
              <span className="text-[9px] font-semibold text-slate-400 uppercase tracking-tight mt-1">
                Aproveitamento
              </span>
            </div>
          </div>
        ...
        {/* Seção de Desempenho por Bloco (Roxo Violeta Suave) */}
